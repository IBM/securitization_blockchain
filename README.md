...
In a separate tab, run the following commands from the root directory of this project to copy the chaincode files into the "chaincode" container, build the binary, and start the chaincode service
```
